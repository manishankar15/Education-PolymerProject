...
class MyJavascript extends PolymerElement {
    static get template() {
        return html `
...
<custom-style>
  <style is="custom-style">
    .img {
      ...
      <center>
      <h2><u>Course-JAVASCRIPT</u></h2>
      <div class="small-container single-product">
      <div class="row">
          <div class="col-2">
          
          <!---iron image is for adding image--->
          <iron-image sizing="contain" class="img" alt="The Polymer logo." src="../images/javascript.png"></iron-image>
...
window.customElements.define('my-javascript', MyJavascript);